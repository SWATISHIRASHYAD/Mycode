def change_number(num):#immutable int,hence global variable remains same
    num+=10

def change_list(num_list):#mutable list,hence it will change the global variable also
    num_list.append(20)
